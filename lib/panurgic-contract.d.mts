...
export type IntegrityStatus = "verified" | "unsigned" | "modified";
...
export function verifyPacketIntegrity(packet: unknown): Promise<{ status: IntegrityStatus; reason: string }>;
